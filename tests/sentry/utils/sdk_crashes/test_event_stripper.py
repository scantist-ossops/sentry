...
from sentry.utils.sdk_crashes.sdk_crash_detector_configs import (
    _cocoa_sdk_crash_detector_config,
    _react_native_sdk_crash_detector_config,
)
...
def test_strip_frames_sdk_frames_keep_after_matcher(store_and_strip_event):
    ...
    config = copy.deepcopy(_react_native_sdk_crash_detector_config)
