      ...
      missingMembers: [
        {
          ...
          users: [
            ...
            {
              commitCount: 5,
              email: 'cinco@sentry.io',
              externalId: 'github:cinco',
            },
            {
              commitCount: 4,
              email: 'four@sentry.io',
              externalId: 'github:four',
            },
            {
              commitCount: 3,
              email: 'three@sentry.io',
              externalId: 'github:three',
            },
            {
              commitCount: 2,
              email: 'two@sentry.io',
              externalId: 'github:two',
            },
            {
              commitCount: 6,
              email: 'asap@sentry.io',
              externalId: 'github:asap',
            },
            {
              commitCount: 5,
              email: 'member@sentry.io',
              externalId: 'github:member',
            },
            {
              commitCount: 4,
              email: 'me@sentry.io',
              externalId: 'github:me',
            },
            {
              commitCount: 3,
              email: 'testy@sentry.io',
              externalId: 'github:testy',
            },
            {
              commitCount: 2,
